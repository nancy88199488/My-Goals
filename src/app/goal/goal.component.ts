...
export class GoalComponent implements OnInit {
  ...
  addNewGoal(goal){
    ...
    goal.completeDate = new Date(cDate.getFullYear(), cDate.getMonth(), cDate.getDate()); //Convert the date being passed to the Goal object to the correct format (YYYY, MM, DD).
